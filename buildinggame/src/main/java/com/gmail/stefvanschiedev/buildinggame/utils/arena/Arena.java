...
public class Arena {
                ...
                if (gamePlayer.getGamePlayerType() == GamePlayerType.PLAYER) {
                    ...
                    player.getInventory().setItem(8, new ItemBuilder(player, Material.BOOK)
                            ...
                            .setClickEvent(event -> {
                                ...
                                String fileName = LocalDateTime.now().format(dateTimeFormatter) + players + ".schem";
                                File file = new File(SettingsManager.getInstance().getReportsSchematicsFolder(), fileName);
    ...
    public void nextMatch() {
        ...
        getPlots().forEach(plot -> {
            ...
            Map<Entity, Location> entities = plot.getEntities();
