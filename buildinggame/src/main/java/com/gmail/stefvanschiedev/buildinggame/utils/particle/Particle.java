    ...
    public void render() {
        ...
        switch (type) {
            ...
            case MAGIC_CRIT:
                ...
                break;
            case NAUTILUS:
                location.getWorld().spawnParticle(org.bukkit.Particle.NAUTILUS, location, amount, offsetX, offsetY,
                        offsetZ);
                break;
            case REDSTONE_MAGIC:
            ...
            case SPELL:
                ...
                break;
            case SQUID_INK:
                location.getWorld().spawnParticle(org.bukkit.Particle.SQUID_INK, location, amount, offsetX, offsetY,
                        offsetZ);
                break;
            case SWEEP_ATTACK:
